...
files <- files[str_detect(files, pattern = '_matched_control_regions')]
...
prsice_sets_og <- read_csv('/Dedicated/jmichaelson-wdata/lcasten/sli_wgs/prs/pathway_prs/prsice_info.cogPerf.complement.csv')
prsice_sets
bind_rows(prsice_sets_og, prsice_sets) %>% 
  write_csv('/Dedicated/jmichaelson-wdata/lcasten/sli_wgs/prs/pathway_prs/prsice_info.cogPerf.complement_rand_controls.csv')

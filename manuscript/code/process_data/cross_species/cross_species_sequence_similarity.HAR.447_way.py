...
# Read in HAR
regions = read_bed_file('/Dedicated/jmichaelson-wdata/lcasten/sli_wgs/git/language_evo/manuscript/supplemental_materials/HAR.hg38.sorted_autosomes.bed')
...
maf_file_subset = '/Dedicated/jmichaelson-genome/Zoonomia/447-way_mammalian_alignment_2023/tmp/chr' + str(i) + '.HAR.maf' ## maf subset to regions of interest
output_file = "/Dedicated/jmichaelson-genome/Zoonomia/447-way_mammalian_alignment_2023/tmp/HAR_hg38_sequence_similarity_results.chr" + str(i) + ".csv"  # Output CSV file
...
# subset_maf(maf_file, roi, maf_file_subset)

...
haqer <- read_tsv('/Dedicated/jmichaelson-wdata/lcasten/tools/ref_data/human_accelerated_regions/HAQERs/Mangan-Cell2022/other_regions/rand.hg38.bed', col_names = FALSE)
...
## save to file
outf <- str_c('/Dedicated/jmichaelson-wdata/lcasten/sli_wgs/HAQER_variant_associations/data/SPARK_WGS/chr', chr, '_RAND_10Kb_flank.hg38.rds')
wd %>% 
    write_rds(outf)
...
tmp_brd %>% 
    write_csv(str_c('/Dedicated/jmichaelson-wdata/lcasten/sli_wgs/HAQER_variant_associations/data/SPARK_WGS/chr', chr, '_RAND_10Kb_flank.hg38.reversion_count_summary.csv'))
